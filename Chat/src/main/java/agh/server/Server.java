...
public interface Server extends Remote, Serializable {
    ...
    SimplifiedUserList getUserContacts(String login) throws RemoteException;
    ...
    SimplifiedUserList getAllUsers() throws RemoteException;
    SimplifiedUserList findUser(String login, String name, String lastName) throws RemoteException;
